                ...
                <div class="collapse navbar-collapse" id="navbarSupportContent">
                                ...
                                <div class="dropdown-body">
                                    <div class="d-flex flex-wrap align-items-center">
                                        <a href="#" class="dropdown-item">
                                            <img src="{{asset('backend/assets/img/icon-account.png')}}" alt="image">
                                            <span class="d-block mb-0">Account</span>
                                        </a>

                                        <a href="#" class="dropdown-item">
                                            <img src="{{asset('backend/assets/img/icon-google.png')}}" alt="image">
                                            <span class="d-block mb-0">Search</span>
                                        </a>

                                        <a href="#" class="dropdown-item">
                                            <img src="{{asset('backend/assets/img/icon-map.png')}}" alt="image">
                                            <span class="d-block mb-0">Maps</span>
                                        </a>

                                        <a href="#" class="dropdown-item">
                                            <img src="{{asset('backend/assets/img/icon-youtube.png')}}" alt="image">
                                            <span class="d-block mb-0">YouTube</span>
                                        </a>

                                        <a href="#" class="dropdown-item">
                                            <img src="{{asset('backend/assets/img/icon-playstore.png')}}" alt="image">
                                            <span class="d-block mb-0">Play</span>
                                        </a>

                                        <a href="#" class="dropdown-item">
                                            <img src="{{asset('backend/assets/img/icon-gmail.png')}}" alt="image">
                                            <span class="d-block mb-0">Gmail</span>
                                        </a>

                                        <a href="#" class="dropdown-item">
                                            <img src="{{asset('backend/assets/img/icon-drive.png')}}" alt="image">
                                            <span class="d-block mb-0">Drive</span>
                                        </a>

                                        <a href="#" class="dropdown-item">
                                            <img src="{{asset('backend/assets/img/icon-calendar.png')}}" alt="image">
                    ...
                    <ul class="navbar-nav right-nav align-items-center">
                        ...
                        <li class="nav-item dropdown language-switch-nav-item">
                            <a href="#" class="nav-link dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="{{asset('backend/assets/img/us-flag.jpg')}}" alt="image">
                            ...
                            <div class="dropdown-menu">
                                <a href="#" class="dropdown-item d-flex justify-content-between align-items-center">
                                    ...
                                    <img src="{{asset('backend/assets/img/germany-flag.jpg')}}" alt="flag">
                                </a>

                                <a href="#" class="dropdown-item d-flex justify-content-between align-items-center">
                                    <span>French</span>

                                    <img src="{{asset('backend/assets/img/france-flag.jpg')}}" alt="flag">
                                </a>

                                <a href="#" class="dropdown-item d-flex justify-content-between align-items-center">
                                    <span>Spanish</span>

                                    <img src="{{asset('backend/assets/img/spain-flag.jpg')}}" alt="flag">
                                </a>

                                <a href="#" class="dropdown-item d-flex justify-content-between align-items-center">
                                    <span>Russian</span>

                                    <img src="{{asset('backend/assets/img/russia-flag.jpg')}}" alt="flag">
                                </a>

                                <a href="#" class="dropdown-item d-flex justify-content-between align-items-center">
                                    <span>Italian</span>

                                    <img src="{{asset('backend/assets/img/italy-flag.jpg')}}" alt="flag">
                                </a>
                            </div>
                        </li>
                            ...
                            <div class="dropdown-menu">
                                ...
                                <div class="dropdown-body">
                                    <a href="#" class="dropdown-item d-flex align-items-center">
                                        <div class="figure">
                                            <img src="{{asset('backend/assets/img/user1.jpg')}}" class="rounded-circle" alt="image">
                                        </div>
                                    ...
                                    <a href="#" class="dropdown-item d-flex align-items-center">
                                        <div class="figure">
                                            <img src="{{asset('backend/assets/img/user2.jpg')}}" class="rounded-circle" alt="image">
                                        </div>
                                    ...
                                    <a href="#" class="dropdown-item d-flex align-items-center">
                                        <div class="figure">
                                            <img src="{{asset('backend/assets/img/user3.jpg')}}" class="rounded-circle" alt="image">
                                        </div>
                                    ...
                                    <a href="#" class="dropdown-item d-flex align-items-center">
                                        <div class="figure">
                                            <img src="{{asset('backend/assets/img/user4.jpg')}}" class="rounded-circle" alt="image">
                                        </div>
